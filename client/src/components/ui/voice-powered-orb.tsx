...
export const VoicePoweredOrb: FC<VoicePoweredOrbProps> = ({
  className,
  hue = 270, // Purple hue for AI Policy Whisperer branding
  ...
  const frag = /* glsl */ `
    ...
    // AI Policy Whisperer brand colors - purple/violet gradient
    const vec3 baseColor1 = vec3(0.545, 0.361, 0.965); // Violet-500
    const vec3 baseColor2 = vec3(0.388, 0.400, 0.945); // Indigo-500
    const vec3 baseColor3 = vec3(0.294, 0.133, 0.584); // Purple-900
